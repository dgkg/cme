...
function validateForm(){
    ...
    $val_tutorial_id       = $('#tutorial-id').val();
...
function displaySucces(idTutorial) {
    // creation du lien et animation
    $('.msg-erreur').hide();
    $("#tutorial-id-created").attr("href","/tutoriel/post/"+idTutorial);
    $('.nouv-post-form').hide();
    $('.msg-succes').fadeIn();
